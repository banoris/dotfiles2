...
# Used this in bash a lot. E.g., need to create a dir before running
# a long command that is already pasted to the terminal
...
bindkey "^[[Z" reverse-menu-complete # Bind Shift-Tab to go to the previous item
...
# https://unix.stackexchange.com/a/594305. But yank (C-y) doesn't work like in Bash
...
# zsh-autosuggestion breaks multiple words yank
# https://github.com/zsh-users/zsh-autosuggestions/issues/363#issuecomment-449554814
ZSH_AUTOSUGGEST_IGNORE_WIDGETS+=(backward-kill-space-word)
